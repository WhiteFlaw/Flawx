...
const size = computed(() => {
  let sy_carousel_width = `width: ${props.width}px`;
  let sy_carousel_height = `height: ${props.height}px`;
  let el_carousel_width = `width: ${props.width}px`;
  let el_carousel_height = `${props.height * 0.89}px`;
  return {
    sy_carousel_width,
    sy_carousel_height,
    el_carousel_width,
